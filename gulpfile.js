 ...
 */
// Project related.
var project              = 'Penrose'; // Project Name.
var projectURL           = 'dev.wordpress3:8888'; // Project URL. Could be something like localhost:8888.
var productURL           = './library/bower_components/'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
...
// Style related.
var styleSRC             = './library/css/style.scss'; // Path to main .scss file.
var styleDestination     = './'; // Path to place the compiled CSS file.
// Defualt set to root folder.

// JS Vendor related.
var jsVendorSRC          = './library/js/vendor/*.js'; // Path to JS vendor folder.
...
// Watch files paths.
var styleWatchFiles      = './library/css/**/*.scss'; // Path to all *.scss files inside css folder and inside them.
var vendorJSWatchFiles   = './library/js/vendor/*.js'; // Path to all vendor JS files.
