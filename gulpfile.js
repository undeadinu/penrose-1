 ...
 * Browser Sync
 *
 * Asynchronous browser syncing of library across multiple devices!! Watches for changes to js, image and php files
 ...
 * Scripts: Vendors
 *
 * Look at src/js and concatenate those files, send them to library/js where we then minimize the concatenated file.
*/
gulp.task('vendorsJs', function() {
	return 	gulp.src(['./library/js/vendor/*.js', bower+'**/*.js'])
...
gulp.task('scriptsJs', function() {
	return 	gulp.src('./library/js/custom/*.js')
...
// Add the newer pipe to pass through newer images only
	return 	gulp.src(['./library/images/raw/**/*.{png,jpg,gif}'])
 ...
 */
 ...
 gulp.task('cleanup', function() {
 	return 	gulp.src(['./library/bower_components', '**/.sass-cache','**/.DS_Store'], { read: false }) // much faster
  ...
  * buildImages copies all the images from images folder in library while ignoring images inside raw folder if any
  */
...
gulp.task('buildImages', function() {
	return 	gulp.src(['library/images/**/*', '!library/images/raw/**'])
		 		.pipe(gulp.dest(build+'library/images/'))
 ...
 */
 ...
 gulp.task('default', ['styles', 'vendorsJs', 'scriptsJs', 'images', 'browser-sync'], function () {
 	gulp.watch('./library/images/raw/**/*', ['images']);
 	gulp.watch('./library/css/**/*.scss', ['styles']);
 	gulp.watch('./library/js/**/*.js', ['scriptsJs', browserSync.reload]);
